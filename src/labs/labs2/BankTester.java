...
abstract class Transaction{
    ...
    abstract double totalProvision();
...
class FlatPercentProvisionTransaction extends Transaction{
    ...
    @Override
    double totalProvision() {
        return ((int)getDoubleAmount())*centsPerDolar/100.0;
    }
}
class Bank{
    String name;
    ...
    public boolean makeTransaction(Transaction t){
        ...
        if(from.getDoubleBalance()<t.getDoubleAmount()+t.totalProvision()) return false;

        from.setBalance(String.format("%.2f$",from.getDoubleBalance()-t.getDoubleAmount()-t.totalProvision()));
        to.setBalance(String.format("%.2f$",t.getDoubleAmount()+to.getDoubleBalance()));
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass()) return false;
        Bank bank = (Bank) o;
        return size == bank.size && totalTransfers == bank.totalTransfers && totalProvision == bank.totalProvision && Objects.equals(name, bank.name) && Arrays.equals(accounts, bank.accounts);
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(name, size, totalTransfers, totalProvision);
